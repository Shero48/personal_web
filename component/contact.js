...
const contact = () => {
    ...
    const handle_click=async(e)=>{
      ...
      // console.log(send_load)
      console.log(result)
      console.log(send,send_err)
                  ...
                  <form onSubmit={(e)=>handle_click(e)}  className='w-full z-30 relative flex z-30 flex-col gap-4'>
                      <div className='w-9/10 flex flex-row gap-4'>
                          <label className='w-1/2'>
                              <input onChange={handle_change} value={data.f_name} className='invalid:border-pink-500 w-full mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='First_Name' name='f_name'/>
                          </label>
                          <label className='w-1/2'>
                              <input onChange={handle_change} value={data.l_name} className='invalid:border-pink-500 w-full mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='Last_Name' name='l_name'/>
                          </label>
                      </div>
                      <label>
                          <input onChange={handle_change} value={data.email} className='invalid:border-pink-500 w-9/10 mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='Your Email' name='email'/>
                      </label>
                      <label>
                          <input onChange={handle_change} value={data.contact} className='invalid:border-pink-500 w-9/10 mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='Your Contact' name='contact'/>
                      </label>
                      <label>
                          <input onChange={handle_change} value={data.sub} className='invalid:border-pink-500 w-9/10 mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='Subject' name='sub'/>
                      </label>
                      <label>
                          <textarea onChange={handle_change} value={data.msg} className='invalid:border-pink-500 w-9/10 mt-4 border-2 border-primary outline-none px-4 py-2 text-[15px] tracking-[2px]' placeholder='Message ...' name='msg'></textarea>
                      </label>
